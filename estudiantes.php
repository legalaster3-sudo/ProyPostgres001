...
echo  "<td>rude</td>"; // Encabezado Rude
echo  "<td>fecha nacimiento</td>"; // Encabezado Fecha nacimiento
...
while ($columna = mysqli_fetch_array($consulta)){
    ...
    echo  "<td>".$columna['id']."</td>"; // Mostrar ID
    echo  "<td>".$columna['nombre_estudiante']."</td>"; // Mostrar Nombres
    ...
    echo  "<td>".$columna['rude']."</td>"; // Mostrar Dirección
    echo  "<td>".$columna['fecha_nacimiento']."</td>"; // Mostrar Dirección
